...
use AppBundle\Process\KakuroClassifier;

class ClassifyKakuroCommand extends ContainerAwareCommand
{
    protected 
        $em,
        $parameters;
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $t = KakuroClassifier::autoExecute($parameters, null);
